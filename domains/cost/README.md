...
| # | 問い | ノート |
|---|---|---|
| 1 | 何が課金対象で、何が課金されないか | _未追加_ |
| 2 | ティアリングでどこまで下がるか | _未追加_ |
| 3 | 見積もりが外れる典型的な前提は何か | _未追加_ |
| 4 | Snapshot が容量に与える影響をどう見るか | _未追加_ |
| 5 | コストと可用性・性能のトレードオフをどう提示するか | _未追加_ |
...
- [ライフサイクル軸で探す](../../docs/ja/navigation.md#ライフサイクル軸--playbooks)
