...
| NFS와 SMB를 같은 데이터에 사용 | [보안 스타일이 권한 평가 모델을 결정한다](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) | [보안·거버넌스](../en/domains/security-governance/) (English) |
| **SMB로 운영 중인 볼륨을 NFS에서도 사용하고 싶다** | [SMB로 운영 중인 볼륨에 NFS를 추가하는 데 복제는 필요 없다](../en/domains/multiprotocol-identity/notes/adding-a-protocol-does-not-need-a-clone.md) (English) | [보안 스타일이 권한 평가 모델을 결정한다](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
| **NFS 측에서 권한을 확인하거나 거부 이유를 파악하고 싶다** | [NFS 측 권한 표현은 실제 허용/거부와 일치하지 않는다](../en/domains/multiprotocol-identity/notes/nfs-side-view-does-not-explain-ntfs-denials.md) (English) | [보안 스타일이 권한 평가 모델을 결정한다](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
...
| SMB가 갑자기 제공되지 않게 되었다 | [SMB를 제공할 수 없는 SVM](../en/domains/multiprotocol-identity/notes/smb-service-lost-on-cifs-server-delete.md) (English) | [SMB 사용자 관리와 감사 결정 트리](../en/reference/decision-trees/smb-identity-and-audit.md) (English) |
| 감사 로그를 활성화하고 싶다 / 로컬 사용자를 정리하고 싶다 | [감사 대상 소진은 액세스를 멈춘다](../en/domains/security-governance/notes/audit-log-space-and-client-access.md) (English) | [최종 로그온 속성은 없다](../en/domains/multiprotocol-identity/notes/local-user-inventory-without-last-logon.md) (English) |
...
| **블록으로 갈지 Amazon EBS로 충분한지 판단이 서지 않는다** | [블록 스토리지 선택지 비교](../ja/reference/comparison/block-storage-options.md) (日本語) | [공유 블록이 설계를 바꾸는 조건](../en/domains/block-storage/notes/when-shared-block-changes-the-design.md) (English) |
