...
| **Kosten gegen einen bestehenden Amazon-EBS-Bestand vergleichen** | [Woran Amazon EBS aufhört, die günstigere Antwort zu sein](../ja/domains/block-storage/notes/when-ebs-stops-being-the-cheaper-answer.md) (日本語) | [Blockspeicher-Schnellstart](../en/domains/block-storage/quickstart.md) (English) |
| **Daten auf einem LUN über Dateien oder die S3-API analysieren, ohne die Produktion anzufassen** | [LUN-Inhalte erscheinen nicht auf den Dateiprotokollen](../ja/domains/block-storage/notes/lun-contents-do-not-reach-file-protocols.md) (日本語) | [Vergleich der Wege von Block zu Dateien](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
