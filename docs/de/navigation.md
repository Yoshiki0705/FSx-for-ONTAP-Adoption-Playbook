...
| **Unklar, ob Block nötig ist oder Amazon EBS reicht** | [Vergleich der Blockspeicher-Optionen](../ja/reference/comparison/block-storage-options.md) (日本語) | [Wann geteilter Block das Design ändert](../ja/domains/block-storage/notes/when-shared-block-changes-the-design.md) (日本語) |
