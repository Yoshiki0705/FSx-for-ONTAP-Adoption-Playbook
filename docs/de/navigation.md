...
| **Ein Volume in eine andere SVM verschieben oder prüfen, ob ein FlexClone verschoben werden kann** | [`volume rehost` ändert die besitzende SVM, nicht den Inhalt](../ja/domains/block-storage/notes/volume-rehost-changes-ownership-not-contents.md) (日本語) | [Vergleich der Wege von Block zu Dateien](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
