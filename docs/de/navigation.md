...
| **Ein bereits per SMB genutztes Volume auch über NFS bereitstellen** | [NFS auf einem bereits per SMB bereitgestellten Volume braucht keinen Klon](../ja/domains/multiprotocol-identity/notes/adding-a-protocol-does-not-need-a-clone.md) (日本語) | [Der Security Style bestimmt das Berechtigungsmodell](../ja/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (日本語) |
| **Berechtigungen auf der NFS-Seite prüfen oder eine Verweigerung erklären** | [Die Berechtigungsansicht auf der NFS-Seite entspricht nicht dem tatsächlichen Ergebnis](../ja/domains/multiprotocol-identity/notes/nfs-side-view-does-not-explain-ntfs-denials.md) (日本語) | [Der Security Style bestimmt das Berechtigungsmodell](../ja/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (日本語) |
...
| SMB wird plötzlich nicht mehr bereitgestellt | [Eine SVM, die SMB nicht bereitstellen kann](../ja/domains/multiprotocol-identity/notes/smb-service-lost-on-cifs-server-delete.md) (日本語) | [Entscheidungsbaum — SMB-Identität und Auditing](../en/reference/decision-trees/smb-identity-and-audit.md) (English) |
| Audit-Logs aktivieren / lokale Benutzer inventarisieren | [Erschöpfung des Ziels stoppt den Zugriff](../ja/domains/security-governance/notes/audit-log-space-and-client-access.md) (日本語) | [Kein Last-Logon-Attribut vorhanden](../ja/domains/multiprotocol-identity/notes/local-user-inventory-without-last-logon.md) (日本語) |
