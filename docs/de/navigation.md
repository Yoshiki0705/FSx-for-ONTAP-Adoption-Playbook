...
| NFS und SMB auf denselben Daten | [Der Security Style bestimmt das Berechtigungsmodell](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) | [Sicherheit und Governance](../en/domains/security-governance/) (English) |
| **Ein bereits per SMB genutztes Volume auch über NFS bereitstellen** | [NFS auf einem bereits per SMB bereitgestellten Volume braucht keinen Klon](../en/domains/multiprotocol-identity/notes/adding-a-protocol-does-not-need-a-clone.md) (English) | [Der Security Style bestimmt das Berechtigungsmodell](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
| **Berechtigungen auf der NFS-Seite prüfen oder eine Verweigerung erklären** | [Die Berechtigungsansicht auf der NFS-Seite entspricht nicht dem tatsächlichen Ergebnis](../en/domains/multiprotocol-identity/notes/nfs-side-view-does-not-explain-ntfs-denials.md) (English) | [Der Security Style bestimmt das Berechtigungsmodell](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
...
| SMB-Benutzerverwaltung und Auditing entwerfen | [Entscheidungsbaum — SMB-Identität und Auditing](../en/reference/decision-trees/smb-identity-and-audit.md) (English) | [Multiprotokoll und Identität](../en/domains/multiprotocol-identity/) (English) |
| SMB wird plötzlich nicht mehr bereitgestellt | [Eine SVM, die SMB nicht bereitstellen kann](../en/domains/multiprotocol-identity/notes/smb-service-lost-on-cifs-server-delete.md) (English) | [Entscheidungsbaum — SMB-Identität und Auditing](../en/reference/decision-trees/smb-identity-and-audit.md) (English) |
| Audit-Logs aktivieren / lokale Benutzer inventarisieren | [Erschöpfung des Ziels stoppt den Zugriff](../en/domains/security-governance/notes/audit-log-space-and-client-access.md) (English) | [Kein Last-Logon-Attribut vorhanden](../en/domains/multiprotocol-identity/notes/local-user-inventory-without-last-logon.md) (English) |
...
| **Unklar, ob Amazon EFS reicht oder FSx for ONTAP nötig ist** | [Entscheidungsbaum — welcher AWS-Dateispeicher](../ja/reference/decision-trees/file-storage-selection.md) (日本語) | [Vergleich der Dateispeicher-Optionen](../ja/reference/comparison/file-storage-options.md) (日本語) |
| **Block über iSCSI oder NVMe-oF bereitstellen** | [Entscheidungsbaum — Blockprotokoll und Layout](../ja/reference/decision-trees/block-protocol-and-layout.md) (日本語) | [Blockspeicher](../en/domains/block-storage/) (English) |
| **Unklar, ob Block nötig ist oder Amazon EBS reicht** | [Vergleich der Blockspeicher-Optionen](../ja/reference/comparison/block-storage-options.md) (日本語) | [Wann geteilter Block das Design ändert](../en/domains/block-storage/notes/when-shared-block-changes-the-design.md) (English) |
| **Kosten gegen einen bestehenden Amazon-EBS-Bestand vergleichen** | [Woran Amazon EBS aufhört, die günstigere Antwort zu sein](../en/domains/block-storage/notes/when-ebs-stops-being-the-cheaper-answer.md) (English) | [Blockspeicher-Schnellstart](../en/domains/block-storage/quickstart.md) (English) |
| **Daten auf einem LUN über Dateien oder die S3-API analysieren, ohne die Produktion anzufassen** | [LUN-Inhalte erscheinen nicht auf den Dateiprotokollen](../en/domains/block-storage/notes/lun-contents-do-not-reach-file-protocols.md) (English) | [Vergleich der Wege von Block zu Dateien](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
| **Ein Volume in eine andere SVM verschieben oder prüfen, ob ein FlexClone verschoben werden kann** | [`volume rehost` ändert die besitzende SVM, nicht den Inhalt](../en/domains/block-storage/notes/volume-rehost-changes-ownership-not-contents.md) (English) | [Vergleich der Wege von Block zu Dateien](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
| **Ein gemessener Durchsatzwert liegt unter der Erwartung** | [Herausfinden, was ein gemessener Durchsatzwert tatsächlich gemessen hat](../ja/reference/decision-trees/measured-throughput-triage.md) (日本語) | [Vergleich der Hebel für mehr Durchsatz](../ja/reference/comparison/throughput-levers.md) (日本語) |
...
| **Aus der eigenen Branche heraus herausfinden, was zu entscheiden ist** | [Branchen-Ressourcenkarte — Lesereihenfolge](../ja/reference/industry-resource-map.md#業種から入ったときの読む順序) (日本語) | [Branchenindex](../ja/reference/industry-resource-map.md#業種別索引) (日本語) |
| **Ein bereits eingesetztes Produkt mit FSx for ONTAP kombinieren** | [ISV- und SaaS-Lösungskarte nach Problem](../en/reference/isv-solution-map.md) (English) | [Kandidaten, die das Aufnahmekriterium nicht erfüllen](../en/reference/isv-solution-map.md#candidates-that-did-not-meet-the-bar) (English) |
...
| KI-/ML-Trainingsdaten ablegen und pro Experiment verzweigen | [Grenzen von Datensatzversionen und Experimentzweigen](../ja/domains/data-utilization/notes/dataset-versions-and-experiment-branches.md) (日本語) | [Die drei Dinge, die beim Ausgeben von Zweigen zu begrenzen sind](../ja/domains/security-governance/notes/self-service-without-storage-admin.md) (日本語) |
