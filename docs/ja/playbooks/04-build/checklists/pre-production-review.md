...
- [ ] **ARP の学習期間と対応プロトコルを、使う ONTAP の版で確認した**。**「30 日の学習期間が必要」は世代に依存する条件です。** [ベンダーのドキュメント](https://docs.netapp.com/us-en/ontap/anti-ransomware/index.html)は、**ONTAP 9.16.1 以降は学習期間を必要としない事前学習済みモデル（ARP/AI）**であり、**NAS は 9.16.1 以降、SAN は 9.17.1 以降**が対象と記載しています（2026-09-05 に確認）。**30 日を前提に計画を組む前に版を確認してください。** ブロックで使う場合は SAN 対応の版かどうかが分岐点です
