...
> **この不一致について**: 両方の記載を 2026-09-05 に確認した事実を書いています。**ドキュメントの誤りとしては扱っていません。** AWS へのドキュメントフィードバックまたは Support 経由の確認は、この記述時点で実施していません。**セッション数を決めるときは、自分の構成のスループット容量から計算してください。**
...
**決めるべきことは残ります。** セッション数は必要な帯域から決める値で、既定でも上限でもありません。**1 セッション 625 MBps を目安に、自分のスループット容量から計算してください。** そして **決めた数と理由を設計文書に書き残してください。** 手順書に「8」と固定値で書くと、次に読む人がなぜ 8 なのかを判断できません。
