...
> **この記載差について**: セキュリティグループの要件表に 4420 と 8009 が無いことは 2026-09-05 に確認した事実です。**ドキュメントの誤りとしては扱っていません。** AWS へのドキュメントフィードバックおよび Support 経由の確認は、この記述時点で実施していません。**必要なポートは要件表ではなく、使うプロトコルの手順ページから拾ってください。**
