...
| 操作 | 結果 |
|---|---|
| SVM 作成後に、Amazon FSx が OU 内に作成した計算機オブジェクトを移動する | **SVM が misconfigured になります** |
...
| 3 | 資格情報を更新したら Amazon FSx 側の構成も更新する手順を書く | 片側だけ更新する事故を防げます |
