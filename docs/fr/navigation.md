...
| **Déplacer un volume vers un autre SVM, ou vérifier si un FlexClone peut l'être** | [`volume rehost` change le SVM propriétaire, pas le contenu](../ja/domains/block-storage/notes/volume-rehost-changes-ownership-not-contents.md) (日本語) | [Comparaison des voies pour porter du bloc vers des fichiers](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
