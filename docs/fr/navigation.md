...
| **Hésitation entre le bloc et Amazon EBS** | [Comparaison des options de stockage bloc](../ja/reference/comparison/block-storage-options.md) (日本語) | [Ce qui fait changer la conception avec du bloc partagé](../ja/domains/block-storage/notes/when-shared-block-changes-the-design.md) (日本語) |
