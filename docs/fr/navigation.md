...
| NFS et SMB sur les mêmes données | [Le style de sécurité détermine le modèle de permissions](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) | [Sécurité et gouvernance](../en/domains/security-governance/) (English) |
| **Servir en NFS un volume déjà utilisé en SMB** | [Ajouter NFS à un volume déjà servi en SMB ne demande aucun clone](../en/domains/multiprotocol-identity/notes/adding-a-protocol-does-not-need-a-clone.md) (English) | [Le style de sécurité détermine le modèle de permissions](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
| **Vérifier les permissions côté NFS, ou expliquer un refus** | [La vue des permissions côté NFS ne correspond pas au résultat appliqué](../en/domains/multiprotocol-identity/notes/nfs-side-view-does-not-explain-ntfs-denials.md) (English) | [Le style de sécurité détermine le modèle de permissions](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
...
| SMB a cessé d'être servi sans prévenir | [Un SVM incapable de servir SMB](../en/domains/multiprotocol-identity/notes/smb-service-lost-on-cifs-server-delete.md) (English) | [Arbre de décision — identité SMB et audit](../en/reference/decision-trees/smb-identity-and-audit.md) (English) |
| Activer les journaux d'audit / inventorier les utilisateurs locaux | [L'épuisement de la destination interrompt l'accès](../en/domains/security-governance/notes/audit-log-space-and-client-access.md) (English) | [Aucun attribut de dernière connexion](../en/domains/multiprotocol-identity/notes/local-user-inventory-without-last-logon.md) (English) |
...
| **Hésitation entre Amazon EFS et FSx for ONTAP** | [Arbre de décision — quel stockage de fichiers AWS](../ja/reference/decision-trees/file-storage-selection.md) (日本語) | [Comparaison des options de stockage de fichiers](../ja/reference/comparison/file-storage-options.md) (日本語) |
| **Servir du bloc en iSCSI ou NVMe-oF** | [Arbre de décision — protocole bloc et disposition](../ja/reference/decision-trees/block-protocol-and-layout.md) (日本語) | [Stockage bloc](../en/domains/block-storage/) (English) |
| **Hésitation entre le bloc et Amazon EBS** | [Comparaison des options de stockage bloc](../ja/reference/comparison/block-storage-options.md) (日本語) | [Ce qui fait changer la conception avec du bloc partagé](../en/domains/block-storage/notes/when-shared-block-changes-the-design.md) (English) |
| **Comparer le coût avec un parc Amazon EBS existant** | [Ce qui fait qu'Amazon EBS cesse d'être moins cher](../en/domains/block-storage/notes/when-ebs-stops-being-the-cheaper-answer.md) (English) | [Démarrage rapide du stockage bloc](../en/domains/block-storage/quickstart.md) (English) |
| **Analyser des données sur un LUN via des fichiers ou l'API S3 sans toucher à la production** | [Le contenu d'un LUN n'apparaît pas sur les protocoles de fichiers](../en/domains/block-storage/notes/lun-contents-do-not-reach-file-protocols.md) (English) | [Comparaison des voies pour porter du bloc vers des fichiers](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
| **Déplacer un volume vers un autre SVM, ou vérifier si un FlexClone peut l'être** | [`volume rehost` change le SVM propriétaire, pas le contenu](../en/domains/block-storage/notes/volume-rehost-changes-ownership-not-contents.md) (English) | [Comparaison des voies pour porter du bloc vers des fichiers](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
| **Un débit mesuré plus faible que prévu** | [Déterminer ce qu'une valeur de débit a réellement mesuré](../ja/reference/decision-trees/measured-throughput-triage.md) (日本語) | [Comparaison des leviers de débit](../ja/reference/comparison/throughput-levers.md) (日本語) |
...
| **Décider comment mettre en place la supervision** | [Arbre de décision — voie de supervision](../ja/reference/decision-trees/observability-route.md) (日本語) | [Observabilité](../en/domains/observability/) (English) |
| **Savoir quoi décider en partant de son secteur d'activité** | [Carte des ressources par secteur — ordre de lecture](../ja/reference/industry-resource-map.md#業種から入ったときの読む順序) (日本語) | [Index par secteur](../ja/reference/industry-resource-map.md#業種別索引) (日本語) |
| **Combiner un produit déjà en place avec FSx for ONTAP** | [Carte des solutions ISV et SaaS par problème](../en/reference/isv-solution-map.md) (English) | [Candidats n'ayant pas atteint le critère d'inclusion](../en/reference/isv-solution-map.md#candidates-that-did-not-meet-the-bar) (English) |
...
| Héberger des données d'entraînement IA/ML et les brancher par expérience | [Contraintes sur les versions de jeux de données et les branches d'expérience](../ja/domains/data-utilization/notes/dataset-versions-and-experiment-branches.md) (日本語) | [Les trois choses à borner en distribuant des branches](../ja/domains/security-governance/notes/self-service-without-storage-admin.md) (日本語) |
...
| [Observabilité](../en/domains/observability/) | Par quelle voie superviser et où les données peuvent résider |
