...
| **Comparer le coût avec un parc Amazon EBS existant** | [Ce qui fait qu'Amazon EBS cesse d'être moins cher](../ja/domains/block-storage/notes/when-ebs-stops-being-the-cheaper-answer.md) (日本語) | [Démarrage rapide du stockage bloc](../en/domains/block-storage/quickstart.md) (English) |
| **Analyser des données sur un LUN via des fichiers ou l'API S3 sans toucher à la production** | [Le contenu d'un LUN n'apparaît pas sur les protocoles de fichiers](../ja/domains/block-storage/notes/lun-contents-do-not-reach-file-protocols.md) (日本語) | [Comparaison des voies pour porter du bloc vers des fichiers](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
