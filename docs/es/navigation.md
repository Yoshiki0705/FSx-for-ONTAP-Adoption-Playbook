...
| **Sin decidir entre bloque y Amazon EBS** | [Comparación de opciones de almacenamiento de bloque](../ja/reference/comparison/block-storage-options.md) (日本語) | [Cuándo el bloque compartido cambia el diseño](../ja/domains/block-storage/notes/when-shared-block-changes-the-design.md) (日本語) |
