...
| NFS y SMB sobre los mismos datos | [El estilo de seguridad determina el modelo de permisos](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) | [Seguridad y gobernanza](../en/domains/security-governance/) (English) |
| **Servir por NFS un volumen que ya se usa por SMB** | [Añadir NFS a un volumen que ya sirve SMB no requiere ningún clon](../en/domains/multiprotocol-identity/notes/adding-a-protocol-does-not-need-a-clone.md) (English) | [El estilo de seguridad determina el modelo de permisos](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
| **Comprobar los permisos desde el lado NFS o explicar una denegación** | [La vista de permisos del lado NFS no coincide con el resultado aplicado](../en/domains/multiprotocol-identity/notes/nfs-side-view-does-not-explain-ntfs-denials.md) (English) | [El estilo de seguridad determina el modelo de permisos](../en/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (English) |
...
| SMB dejó de servirse sin aviso | [Una SVM que no puede servir SMB](../en/domains/multiprotocol-identity/notes/smb-service-lost-on-cifs-server-delete.md) (English) | [Árbol de decisión — identidad SMB y auditoría](../en/reference/decision-trees/smb-identity-and-audit.md) (English) |
| Habilitar registros de auditoría / inventariar usuarios locales | [El agotamiento del destino detiene el acceso](../en/domains/security-governance/notes/audit-log-space-and-client-access.md) (English) | [No existe atributo de último inicio de sesión](../en/domains/multiprotocol-identity/notes/local-user-inventory-without-last-logon.md) (English) |
...
| **Sin decidir entre Amazon EFS y FSx for ONTAP** | [Árbol de decisión — qué almacenamiento de archivos de AWS](../ja/reference/decision-trees/file-storage-selection.md) (日本語) | [Comparación de opciones de almacenamiento de archivos](../ja/reference/comparison/file-storage-options.md) (日本語) |
| **Servir bloque por iSCSI o NVMe-oF** | [Árbol de decisión — protocolo de bloque y disposición](../ja/reference/decision-trees/block-protocol-and-layout.md) (日本語) | [Almacenamiento de bloque](../en/domains/block-storage/) (English) |
| **Sin decidir entre bloque y Amazon EBS** | [Comparación de opciones de almacenamiento de bloque](../ja/reference/comparison/block-storage-options.md) (日本語) | [Cuándo el bloque compartido cambia el diseño](../en/domains/block-storage/notes/when-shared-block-changes-the-design.md) (English) |
| **Comparar el coste con un parque de Amazon EBS existente** | [Qué hace que Amazon EBS deje de ser la respuesta más económica](../en/domains/block-storage/notes/when-ebs-stops-being-the-cheaper-answer.md) (English) | [Puesta en marcha del almacenamiento de bloque](../en/domains/block-storage/quickstart.md) (English) |
| **Analizar datos de un LUN por archivos o por la API de S3 sin tocar producción** | [El contenido de un LUN no aparece en los protocolos de archivos](../en/domains/block-storage/notes/lun-contents-do-not-reach-file-protocols.md) (English) | [Comparación de vías para llevar bloque a archivos](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
| **Mover un volumen a otra SVM, o comprobar si un FlexClone puede moverse** | [`volume rehost` cambia la SVM propietaria, no el contenido](../en/domains/block-storage/notes/volume-rehost-changes-ownership-not-contents.md) (English) | [Comparación de vías para llevar bloque a archivos](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
| **Un rendimiento medido menor de lo esperado** | [Determinar qué midió realmente una cifra de rendimiento](../ja/reference/decision-trees/measured-throughput-triage.md) (日本語) | [Comparación de palancas para subir el rendimiento](../ja/reference/comparison/throughput-levers.md) (日本語) |
...
| **Averiguar qué decidir partiendo de su sector** | [Mapa de recursos por sector — orden de lectura](../ja/reference/industry-resource-map.md#業種から入ったときの読む順序) (日本語) | [Índice por sector](../ja/reference/industry-resource-map.md#業種別索引) (日本語) |
| **Combinar un producto ya en uso con FSx for ONTAP** | [Mapa de soluciones ISV y SaaS por problema](../en/reference/isv-solution-map.md) (English) | [Candidatos que no cumplen el criterio de inclusión](../en/reference/isv-solution-map.md#candidates-that-did-not-meet-the-bar) (English) |
...
| Alojar datos de entrenamiento de IA/ML y ramificarlos por experimento | [Restricciones de las versiones de conjuntos de datos y las ramas de experimento](../ja/domains/data-utilization/notes/dataset-versions-and-experiment-branches.md) (日本語) | [Las tres cosas que acotar al repartir ramas](../ja/domains/security-governance/notes/self-service-without-storage-admin.md) (日本語) |
