...
| **Mover un volumen a otra SVM, o comprobar si un FlexClone puede moverse** | [`volume rehost` cambia la SVM propietaria, no el contenido](../ja/domains/block-storage/notes/volume-rehost-changes-ownership-not-contents.md) (日本語) | [Comparación de vías para llevar bloque a archivos](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
