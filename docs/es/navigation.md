...
| **Servir por NFS un volumen que ya se usa por SMB** | [Añadir NFS a un volumen que ya sirve SMB no requiere ningún clon](../ja/domains/multiprotocol-identity/notes/adding-a-protocol-does-not-need-a-clone.md) (日本語) | [El estilo de seguridad determina el modelo de permisos](../ja/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (日本語) |
| **Comprobar los permisos desde el lado NFS o explicar una denegación** | [La vista de permisos del lado NFS no coincide con el resultado aplicado](../ja/domains/multiprotocol-identity/notes/nfs-side-view-does-not-explain-ntfs-denials.md) (日本語) | [El estilo de seguridad determina el modelo de permisos](../ja/domains/multiprotocol-identity/notes/security-style-and-permission-evaluation.md) (日本語) |
