...
| **Combinar un producto ya en uso con FSx for ONTAP** | [Mapa de soluciones ISV y SaaS por problema](../ja/reference/isv-solution-map.md) (日本語) | [Candidatos que no cumplen el criterio de inclusión](../ja/reference/isv-solution-map.md#掲載基準を満たさないもの) (日本語) |
