...
| **Comparar el coste con un parque de Amazon EBS existente** | [Qué hace que Amazon EBS deje de ser la respuesta más económica](../ja/domains/block-storage/notes/when-ebs-stops-being-the-cheaper-answer.md) (日本語) | [Puesta en marcha del almacenamiento de bloque](../en/domains/block-storage/quickstart.md) (English) |
| **Analizar datos de un LUN por archivos o por la API de S3 sin tocar producción** | [El contenido de un LUN no aparece en los protocolos de archivos](../ja/domains/block-storage/notes/lun-contents-do-not-reach-file-protocols.md) (日本語) | [Comparación de vías para llevar bloque a archivos](../ja/reference/comparison/block-to-file-routes.md) (日本語) |
