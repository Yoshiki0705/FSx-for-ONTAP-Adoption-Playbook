...
| **An existing setup** (running on Amazon EBS today) | [Where EBS stops being the cheaper answer](../../../ja/domains/block-storage/notes/when-ebs-stops-being-the-cheaper-answer.md) (日本語) | The condition under which its premise breaks. **Per-GB, EBS has the lower price.** The boundary is not the device count |
