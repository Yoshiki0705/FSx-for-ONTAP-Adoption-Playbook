...
| [The rollback window closes when clients start writing](../ja/playbooks/03-migrate/notes/where-the-rollback-window-closes.md) (日本語) | There is no operation that undoes a cutover, and incremental sync depends on the common snapshot |
