...
|---|---|---|
| 01 | [`01-assess/`](playbooks/01-assess/) | Qué hay en el NAS actual y qué va a limitar la migración |
| 02 | [`02-design/`](playbooks/02-design/) | Qué configuración, capacidad, rendimiento y método de protección elegir |
| 03 | [`03-migrate/`](playbooks/03-migrate/) | Qué método usar, cómo conmutar y cómo revertir |
| 04 | [`04-build/`](playbooks/04-build/) | Cómo estructurar IaC, automatización y compilaciones reproducibles |
| 05 | [`05-operate/`](playbooks/05-operate/) | Cómo llevar monitorización, capacidad, respuesta a incidentes y gestión del cambio |
| 06 | [`06-optimize/`](playbooks/06-optimize/) | Hasta dónde ajustar rendimiento y coste |
...
| Módulo | Pregunta que aborda |
|---|---|
| [`data-protection/`](domains/data-protection/) | Snapshot / SnapMirror / SnapLock / copias de seguridad y preparación frente a ransomware |
| [`data-utilization/`](domains/data-utilization/) | Analítica, IA/RAG y acceso mediante la API de S3 |
| [`security-governance/`](domains/security-governance/) | Cifrado, auditoría, diseño de permisos y enfoque de cargas reguladas |
| [`performance/`](domains/performance/) | Diseño de rendimiento, latencia, caché, ancho de banda compartido |
| [`cost/`](domains/cost/) | Capacidad, tiering y la diferencia entre estimaciones y mediciones |
| [`multiprotocol-identity/`](domains/multiprotocol-identity/) | Coexistencia NFS / SMB, integración con Active Directory, mapeo de identidades |

### Referencia transversal — `reference/`

| Directorio | Contenido |
|---|---|
| [`decision-trees/`](reference/decision-trees/) | Diagramas de decisión (método de migración, protección, protocolo) |
| [`comparison/`](reference/comparison/) | Matrices de comparación (compensaciones expuestas de forma simétrica) |
| [`limits/`](reference/limits/) | Límites y cuotas, con fuente y fecha de verificación |
| [`glossary/`](reference/glossary/) | Terminología de ONTAP y AWS |
...
```text
<module>/
├── README.md          # Hub del módulo (JA)
├── README.en.md       # Hub del módulo (EN)
...
Los cuatro niveles de `evidence` permiten al lector juzgar hasta qué punto puede apoyarse en una nota. Consulta la [política de niveles de evidencia](docs/en/evidence-policy.md).
...
Los casos se redactan como **lecciones generalizadas**: cuál era el problema, cómo se decidió y cuál fue el resultado. La plantilla está en [`case-studies/_template/`](case-studies/_template/). Las comprobaciones previas a la publicación están automatizadas con `make audit`.
...
| [`reference/limits/`](reference/limits/) | Límites estructurados con fuente y fecha de verificación |
...
Se agradecen Issues y Pull Requests. Consulta [CONTRIBUTING.md](CONTRIBUTING.md) para las convenciones de redacción y la [política de niveles de evidencia](docs/en/evidence-policy.md) para los criterios de clasificación.
...
| [fsxn-observability-integrations](https://github.com/Yoshiki0705/fsxn-observability-integrations) | Integraciones de observabilidad (métricas, alertas, respuesta automatizada) |
| [fsxn-lakehouse-integrations](https://github.com/Yoshiki0705/fsxn-lakehouse-integrations) | Integraciones Lakehouse (Databricks / Snowflake / Athena / Glue / EMR) |
